...
export function OpportunityModal({
    ...
    return (
        ...
        >
            <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-3xl border border-gray-200 bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-200 md:p-8">
                {/* Close button */}
                <button
                    type="button"
                    onClick={onClose}
                ...
                {/* Title */}
                <h2 className="font-manrope text-xl font-bold text-ink pr-8">
                    {opportunity.title}
                </h2>
