...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg fill="none" viewBox="0 0 24 24" className="h-5 w-5">
        <path d="m9.5 3 .8 2.2 2.3.5 1.6-1.6 2.2 1.3-.7 2.2 1.7 1.7 2.2-.7 1.2 2.2-1.6 1.6.5 2.3 2.2.8v2.5l-2.2.8-.5 2.3 1.6 1.6-1.2 2.2-2.2-.7-1.7 1.7.7 2.2-2.2 1.3-1.6-1.6-2.3.5-.8 2.2H7l-.8-2.2-2.3-.5-1.6 1.6-2.2-1.3.7-2.2-1.7-1.7-2.2.7-1.2-2.2 1.6-1.6-.5-2.3-2.2-.8v-2.5l2.2-.8.5-2.3-1.6-1.6 1.2-2.2 2.2.7 1.7-1.7-.7-2.2 2.2-1.3 1.6 1.6 2.3-.5.8-2.2h2.5Z" stroke="currentColor" strokeWidth="1.2" />
      ...
      <div className="flex h-full">
        ...
        >
          <div className="flex items-center justify-between border-b border-gray-100 px-4 py-4">
            <Link className="flex min-w-0 items-center gap-3 overflow-hidden" href="/admin">
          ...
          <nav className="flex-1 space-y-2 p-3">
            {NAV_ITEMS.map((item) => {
              ...
              return (
                ...
                >
                  <span className={`shrink-0 ${iconClassName(active)}`}>{item.icon}</span>
                  <span
