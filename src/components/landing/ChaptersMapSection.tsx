      ...
      <div className="relative z-[2] mx-auto w-full max-w-7xl">
        <div className="flex flex-col items-center justify-center gap-12 p-8">
          ...
          <div className="relative max-w-2xl text-center">
            ...
            <h2 className="reveal mt-5 mb-4 font-manrope text-4xl leading-tight font-extrabold text-[#b8692d] md:text-5xl lg:text-6xl">
              Chapters across
              <br />
              the Philippines
            </h2>
            <div className="reveal mx-auto mb-5 h-1 w-24 rounded-full bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-400"></div>
            <p className="reveal mx-auto max-w-lg text-lg leading-relaxed text-[#8b6f47]">
              A growing network of youth-led teams delivering programs in their communities.
            </p>
            <div className="reveal mt-6 flex flex-wrap items-center justify-center gap-3 text-xs font-semibold text-[#b8692d]">
